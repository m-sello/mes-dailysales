...
@Table(name = "mobile_money_log")
public class MobileMoneyLog {
    @Id
    @Column("id")
    private String id;
    ...
    @PersistenceCreator
    public MobileMoneyLog(String id, LocalDateTime logDt, String action, String description, String username){
        this.id = id;
        this.logDt = logDt;
        this.action = action;
